...
export class RecipeService {
  ...
  submitApplication(name: string, age: number, ingredients: string[],
                    preparationTimeInMinutes: number, cookingTimeInMinutes: number,
                    numberOfPeople: number, description: string[], picturePath: string) {
    console.log(
        `Recipes added: name: ${name}, age: ${age}, ingredients: ${ingredients}, 
        preparationTimeInMinutes: ${preparationTimeInMinutes}, cookingTimeInMinutes: ${cookingTimeInMinutes},
        numberOfPeople: ${numberOfPeople}, description: ${description}, picturePath: ${picturePath}.`,
    );
  }
}